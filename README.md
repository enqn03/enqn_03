...
| Endpoint-feature temporal residual controlled run | 구현·user dry run 대기 | endpoint feature bypass로 causal temporal path의 input variation 보존 여부를 검사; C32 대비 flag/output만 변경 |
