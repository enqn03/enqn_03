...
| Weak target support-density rasterization audit | 다음 승인 단계 | sigma만 2→3으로 바꿔 on-the-fly support coverage·blur trade-off 확인 |
