...
| Calibration-aware candidate validation | 구현·user execution 대기 | emitted camera candidate의 coordinate domain·round-trip·FOV/edge safety audit; absolute calibration은 여전히 provisional |
