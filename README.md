...
| Detector-refinement audit | 구현·user execution 대기 | planar candidate ROI/lattice regularity and red-component spatial grouping; still no homography/rank selection |
| Independent calibration fit audit | detector refinement result·별도 승인 대상 | direct metrology fit/residual evaluation; config change is separate scope |
