...
| Geometry-aware candidate safety gate | 구현·read-only evaluation 대기 | provisional part geometry 밖 local maxima를 candidate decoding에서 explicit hold; default-disabled for historical configs |
