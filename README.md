...
| Independent metadata/fiducial calibration audit | 다음 승인 대상 | existing DotGrid/SecondaryCamera_Laser00/Checkerboard metadata TIFF로 direct metrology evaluation; config change is separate scope |
