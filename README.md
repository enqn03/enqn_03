...
| Layer-125 visual orientation overlay audit | 구현·user QC 실행 대기 | raw B-stage image와 rank1/rank2 projected XYPT layout을 NIST Fig.2 cavity/overhang criterion으로 deterministic compare; no auto rank selection |
| Independent metadata/fiducial calibration audit | 후속 검증 단계 | NIST Layer Camera Metadata archive 또는 manual physical anchor 확보 시 direct metrology evaluation |
