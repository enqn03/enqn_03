...
| Endpoint-feature temporal residual controlled run | dry run 통과·training 실행 승인 대기 | expected shape·z128 support=3,439·finite loss·MPS 확인; C32 대비 flag/output만 변경 |
