...
| A-only controlled training-duration run | 구현 완료·사용자 실행 대기 | architecture·target·optimizer·seed·decoder 고정, epochs만 8→24; 별도 output으로 run 1 보존 |
