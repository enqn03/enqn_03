...
| Independent metadata/fiducial calibration audit | 다음 승인 대상 | NIST Layer Camera Metadata archive 또는 manual physical anchor로 direct metrology evaluation; config change is separate scope |
