...
| A-only input-sensitivity diagnostic | 구현·사용자 실행 대기 | selected A histories가 frame encoder·temporal mixer·logit map에서 실제로 구분되는지 XCT-independent read-only 확인 |
