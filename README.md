...
| Calibration rank-sensitivity audit | 구현·user execution 대기 | existing residual-only rank 1 vs selected rank 2에서 compact candidate part agreement·machine-coordinate shift 측정 |
| Control-point perturbation robustness audit | 후속 검증 단계 | rank sensitivity 결과 후 perturbation 범위 결정 |
