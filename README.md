...
| Independent metrology metadata pre-audit | 구현·user execution 대기 | existing DotGrid/SecondaryCamera_Laser00/Checkerboard axes·structure·laser candidate QC; no refit/rank selection |
| Independent calibration fit audit | 후속 승인 대상 | pre-audit result를 바탕으로 direct metrology fit/residual evaluation; config change is separate scope |
