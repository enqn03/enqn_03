...
| Endpoint-feature temporal residual controlled run | 다음 승인 단계 | endpoint feature bypass로 causal temporal path의 input variation 보존 여부를 검사 |
