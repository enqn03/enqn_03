...
| A-only model-capacity controlled run | 구현 완료·사용자 실행 대기 | epoch=8 유지, base channel만 8→32; separate output으로 run 1/e24 보존 |
