...
| Checkpoint spatial diagnostic | 확장 구현·사용자 재검증 대기 | top-score tie fraction 및 selected endpoint 간 map MAE/max-absolute를 support 없이 확인 |
| Support-independent candidate decoder | 구현·사용자 재검증 대기 | full-map flat·top-score plateau·temporal invariance 시 coordinate를 withheld |
