...
| Independent fiducial detector feasibility audit | 구현·user execution 대기 | dot-center/corner/red-component local feature metrics and overlays; no homography or rank selection |
| Independent calibration fit audit | detector result·별도 승인 대상 | direct metrology fit/residual evaluation; config change is separate scope |
