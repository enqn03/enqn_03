...
| A-only input-sensitivity diagnostic | 다음 승인 단계 | selected A histories가 frame encoder·temporal mixer·logit map에서 실제로 구분되는지 read-only 확인 |
